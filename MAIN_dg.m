...
% X=X_init;
[Fitness Loss V_DEV Bus01]=objective_function_dg(X',Bus_data,Line_data,load_senarios,m);
P_old=Fitness;
%% Unit Commitment
for iter=1:max_it
    [Fitness Loss V_DEV Bus01]=objective_function_dg(X',Bus_data,Line_data,load_senarios,m);
...
[Fitness Loss V_DEV BUS]=objective_function_dg(Pg',Bus_data,Line_data,load_senarios,1);
[Fitness0 Loss0 V_DEV0 BUS0]=objective_function_dg([(33:37) 1 0],Bus_data,Line_data,load_senarios,1);
% clc
